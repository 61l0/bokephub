...
if($_POST['m']=="single"){ 
	...
	echo"
	<div class=\"wrap\">
		<h2>YouPorn Import - Single Video</h2>
		<form action=\"".admin_url('admin.php?page=tubeace/tubeace-youporn-api.php')."\" method=\"post\">
...
if($_POST['m']=="import"){
	...
	add_post_meta($lastID, 'site', 'youporn.com');
	...
	$data = file_get_contents("http://www.youporn.com/api/webmasters/video_by_id?video_id=$video_id&thumbsize=medium");
	$data = json_decode($data);
...
if($_GET['all']){
	...
	<div class=\"wrap\">
	  ...
	  include('inc/import-youporn.php');
...
if($_GET['cron']){
	...
	$existingCronNames = get_site_option('tubeace_cron_youporn_'.$cron_frequency);
	...
	//if none exist, add new
		...
		update_site_option('tubeace_cron_youporn_'.$cron_frequency, $cronNames);	
...
<div class="wrap">
	...
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-youporn-api.php'); ?>" method="post">
		<table class="form-table">
		    <tbody>
		        <tr>
		    		<th><label for="video_id">YouPorn Video ID</label></th>
		        	<td>
		        ...
		        <tr>
		    		<td></td>
		        	<td>
		        		<input type="hidden" name="page" value="tubeace/tubeace-youporn-api.php">
	...
	<h3>Search Videos</h3>
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-youporn-api.php'); ?>" method="get">
		<table class="form-table">
		    <tbody>
		        <tr>
