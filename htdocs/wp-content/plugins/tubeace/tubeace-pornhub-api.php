...
if($_POST['m']=="single"){ 
	...
	echo"
	<div class=\"wrap\">
		<h2>Pornhub Import - Single Video</h2>
		<form action=\"".admin_url('admin.php?page=tubeace/tubeace-pornhub-api.php')."\" method=\"post\">
...
if($_POST['m']=="import"){
	...
	$data = file_get_contents("http://www.pornhub.com/webmasters/video_by_id?id=$video_id&thumbsize=medium");
	$data = json_decode($data);
...
if($_GET['all']){
	...
	<div class=\"wrap\">
	  ...
	  include('inc/import-pornhub.php');
...
if($_GET['cron']){
	...
	$existingCronNames = get_site_option('tubeace_cron_pornhub_'.$cron_frequency);
	...
	//if none exist, add new
		...
		update_site_option('tubeace_cron_pornhub_'.$cron_frequency, $cronNames);	
	...
	} else { //if already exists, we need to add name to tubeace_cron_pornhub_{frequency}
...
<div class="wrap">
	...
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-pornhub-api.php'); ?>" method="post">
		<table class="form-table">
		    <tbody>
		        <tr>
		    		<th><label for="video_id">Pornhub Video ID</label></th>
		        	<td>
		        ...
		        <tr>
		    		<td></td>
		        	<td>
		        		<input type="hidden" name="page" value="tubeace/tubeace-pornhub-api.php">
	...
	<h3>Search Videos</h3>
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-pornhub-api.php'); ?>" method="get">
		<table class="form-table">
		    <tbody>
		        <tr>
