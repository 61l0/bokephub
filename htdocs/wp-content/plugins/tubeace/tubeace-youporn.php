...
if(isset($_POST['import'])){
	...
	if(!empty($tmpName)){
		copy($tmpName, "$upload_dir[basedir]/tubeace-youporn.csv");
	} else {
	...
	if(empty($error)){
        ...
        $fh = fopen("$upload_dir[basedir]/tubeace-youporn.csv", 'r+');
        $content = fread($fh, filesize("$upload_dir[basedir]/tubeace-youporn.csv"));
        fclose($fh);
...
?>
	...
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-youporn.php'); ?>" method="post" enctype="multipart/form-data">
		...
		<table class="form-table">
		    <tbody>
		        ...
		        <tr>
		    		<th></th>
		        	<td>
		        		<input type="hidden" name="page" value="tubeace/tubeace-youporn.php">
