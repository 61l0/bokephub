...
if(isset($_POST['import'])){
	...
	if(!empty($tmpName)){
		copy($tmpName, "$upload_dir[basedir]/tubeace-pornhub.csv");
	} else {
	...
	if(empty($error)){
        ...
        $fh = fopen("$upload_dir[basedir]/tubeace-pornhub.csv", 'r+');
        $content = fread($fh, filesize("$upload_dir[basedir]/tubeace-pornhub.csv"));
        fclose($fh);
...
?>
	...
	<form action="<?php echo admin_url('admin.php?page=tubeace/tubeace-pornhub.php'); ?>" method="post" enctype="multipart/form-data">
